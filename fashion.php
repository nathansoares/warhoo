...
<section id="new"><div class="container"><a style="text-decoration:none;" href="recent.php"><h3 style=" font-family:Verdana, Geneva, sans-serif; color:#0CF;">#RECENT</h3></a><BR>
        <!-- Page Header -->
        <div class="row">
            <div class=""></div>
...
$seleciona_seguindo = mysql_query("SELECT * FROM seguidores WHERE seguidor=$id   ORDER BY id DESC"
  ...
  if((mysql_num_rows($seleciona_seguindo) == 0)&&(isset($sess)&&(isset($_SESSION['fb_token'])))){?> 
      ...
      $registros = mysql_query("SELECT * FROM tudo WHERE categoria=2 or categoria=0 "
			 ...
			 for($i = $pag-$links; $i <= $pag-1; $i++){
				if($i <= 0){
					...
					echo'<a style=" text-decoration:none; float:left;color:#fff" href="recent.php?pag='.$i.'"  ><div  style=" float:left;width:100px; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded  " ><h4>Back</h4></div></a>';
			  ...
			  for($i = $pag+1; $i <= $pag+1; $i++){
				if($i>$paginas){
					...
					echo'<a class="hidden-xs hidden-sm"style=" float:right; text-decoration:none;color:#fff" href="fashion.php?pag='.$i.'"><div style=" float:right;width:100px; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded col-sm-12 col-xs-12  " ><h4>More</h4></div></a>
					<a class="col-sm-12 col-xs-12 hidden-lg hidden-md" style="  text-decoration:none;color:#fff" href="fashion.php?pag='.$i.'"><div style=" float:right;width:100%; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded  " ><center><h4>More</h4></center></div></a> 
					';
