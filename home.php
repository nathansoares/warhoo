...
<?php
		...
		include ("$nav");
		?><br>
<nav  class="navbar navbar-inverse navbar-static-top" role="navigation"  style="background-color:transparent; border:1px #CCC; margin-top:50px;">
     <div  class="container"> <div style=" width:100px; float:left; margin-top:-10px; margin-left:-30px;  "><img src="img/search_icon.png" width="76" height="76"></div> <div>
...
</ul></div><div class="container"></div><div class="container hidden-xs hidden-sm" style="border-radius:0px; border-color:#FFF;  background-color:#fff"><br><div class="hidden-xs hidden-sm"><div class="col-lg-12">
...
<h3 style=""> FASHION </h3><?php
  ...
  $inicio = ($pag * $maximo) - $maximo;
   ...
   if( $gender == "male"){
      ...
      $seleciona_produtos = mysql_query("SELECT * FROM tudo WHERE categoria=1 && tag=2  ORDER BY id DESC LIMIT $inicio, $maximo"
);  $seguidor = mysql_query("SELECT * FROM seguidores WHERE seguidor='$id'") ;
    $query_seguidor = mysql_fetch_array($seguidor);}
	 if( $gender == "female"){
