...
<div class=" thumbnail" style="box-shadow:0 0 4px #CCC; 
	...
	
	{
		...
		$cadastra_video = mysql_query("INSERT INTO tech(titulo, thumb, embed, descricao, valor, valordolar, valoreuro, categoria, cat, start, type, loja, paypal)VALUES('$titulo','$thumb','$embed','$descricao','$valor','$valordolar','$valoreuro','$categoria','$cat','$start','$type','$loja', '$paypal')");
	if($cadastra_video){
