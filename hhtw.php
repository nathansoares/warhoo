...
<div style=""> <a class="col-sm-12 col-xs-12 hidden-lg hidden-md" style="  text-decoration:none;color:#fff" href="http://www.warhoo.com/hotthisweek/"><div style=" float:right;width:100%; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded  " ><center><h4>More</h4></center></div></a> 
<center><a class=" hidden-sm hidden-xs hidden-md" style="text-decoration:none;" href="http://www.warhoo.com/hotthisweek/" ><div class="thumbnail" style=" width:100%; background-color:transparent; border:0px; height:100px;"> <img class="thumbnail" style="border:0px; background-color:transparent;" src="img/HTW.png"></div></a></center>
