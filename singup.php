...
?></div></nav>
  	  ...
  	  <center>
  	    ...
  	    <div class="container hidden-xs hidden-sm"><div><div class="thumbnail col-lg-4 col-md-6 col-sm-12 col-xs-12" style="float:right; padding:10px; margin:20px; margin-left:30px;">
  	    <?php
include "singup2.php";
?></center></div></div>
</div><br>
