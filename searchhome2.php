...
$(function(){
	...
	$("#pesquisa").keyup(function(){
		...
		if(pesquisa != ''){
			...
			$.post('buscain.php', dados, function(retorna){
...
<center><div class="col-lg-4" style="float:left">
  ...
  $inicio = ($pag * $maximo) - $maximo;
      ...
      $seleciona_produtos = mysql_query("SELECT * FROM loja   ORDER BY id DESC LIMIT $inicio, $maximo");
...
<div class="col-lg-4" style="float:left">
  ...
  $inicio = ($pag * $maximo) - $maximo;
      ...
      $seleciona_produtos = mysql_query("SELECT * FROM tudo WHERE  type=1  ORDER BY id DESC LIMIT $inicio, $maximo"
);  
...
<h3 style=""> FASHION </h3><?php
  ...
  $inicio = ($pag * $maximo) - $maximo;
      ...
      $seleciona_produtos = mysql_query("SELECT * FROM tudo WHERE  tag=1  ORDER BY id DESC LIMIT $inicio, $maximo"
); 
