...
</div><?php }}?></div><center><div  >
        
					
				<a style=" float:right; text-decoration:none;color:#fff" href="follow.php?pag=1"><div style=" float:right;width:100px; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded  " ><h4>More</h4></div></a>';
