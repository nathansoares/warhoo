...
<body style="background-color:#F4F4F4;">
    ...
    <nav  class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#E8E8E8; border:1px #CCC; margin-top:50px;">
        ...
        <H4 style="color:#fff;">&nbsp;</H4><a style="text-decoration:none;" href="follow.php"><span class="btn btn-primary" style=" float:right;background-color:#06F; margin-top:-35px;">Find More</span></a>
...
<div class="row">
  ...
  $seguidor = mysql_query("SELECT * FROM seguidores WHERE seguidor='$id'") ;
	...
	$following = $query_seguidor['seguindo'];
 $seleciona_produtos = mysql_query("SELECT `loja`.* FROM `loja` INNER JOIN `seguidores` ON `loja`.`id` = `seguidores`.`seguindo` ORDER BY `seguidores`.`id` DESC"
); 
