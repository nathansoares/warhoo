...
<html>
	<head>
		...
		<link rel="stylesheet" media="screen" href="slide/css/sequencejs-theme.modern-slide-in.css" />
		...
		<script src="slide/scripts/jquery.sequence-min.js"></script>
		<script src="slide/sequencejs-options.modern-slide-in.js"></script>
	</head>
	<body>
		<div class="sequence-theme">
			<div id="sequence">
				...
				<ul class="sequence-pagination">
					<li><img src="slide/images/tn-model1.png" alt="Model 1" /></li>
					<li><img src="slide/images/tn-model2.png" alt="Model 2" /></li>
					<li><img src="slide/images/tn-model3.png" alt="Model 3" /></li>
				</ul>
