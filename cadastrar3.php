...
<div class=" thumbnail" style="box-shadow:0 0 4px #CCC; 
	...
	-webkit-box-shadow: 0 0 4px #CCC; width:400px;  height:800px; margin-left:35%" id="boxform">
	...
	
	{
		...
		$cadastra_video = mysql_query("INSERT INTO tudo(titulo, thumb, embed, descricao, valor, valordolar, valoreuro, categoria,type, loja, paypal)VALUES('$titulo','$thumb','$embed','$descricao','$valor','$valordolar','$valoreuro','$categoria','$type','$loja', '$paypal')");
	if($cadastra_video){
	...
	?>
  <form  action="" method="post" enctype="multipart/form-data"  style="height:800px;"class="form-control">
