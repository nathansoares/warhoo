...
/*PROCESS*/
	...
	$redirect_url='http://www.warhoo.qlix.com.br/index.php';
	...
	//logout
	$logout = 'http://www.warhoo.qlix.com.br/logout.php';
...
<nav  class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:transparent; border:1px #CCC; margin-top:50px;">
        ...
        <center><form class=""  style=" color:#FC0;   " id="form-pesquisa" action="" method="post"> 
