...
<body>
  ...
  $inicio = ($pag * $maximo) - $maximo;
    ...
    if( ($gender == "male")){
		  $seleciona_produtos = mysql_query("SELECT * FROM tudo WHERE type=3 AND categoria=1  ORDER BY id DESC  LIMIT $inicio, $maximo");}
		   if( ($gender == "female")){
		  $seleciona_produtos = mysql_query("SELECT * FROM tudo WHERE type=3 AND categoria=2  ORDER BY id DESC  LIMIT $inicio, $maximo");}
...
?>
    <?php
		   ...
		   $seleciona_loja = mysql_query("SELECT * FROM types WHERE id = 3");
...
</div><?php }}?></div><a class="hidden-xs hidden-sm" style=" float:right; text-decoration:none;color:#fff" href="page.php?warhoo=3"><div style=" float:right;width:100px; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded  " ><center><h4>More</h4></center></div></a> <a class="col-sm-12 col-xs-12 hidden-lg hidden-md" style="  text-decoration:none;color:#fff" href="page.php?warhoo=3"><div style=" float:right;width:100%; height:40px; font:#fff; border:solid 2px #CCC; background-color:#09f; " class=" img-rounded  " ><center><h4>More</h4></center></div></a> 
